...
const TopNav = () => {
  ...
  return (
    <div className="h-[10vh] relative w-full flex items-center gap-2 justify-center ">
      ...
      <input type="text"
       ...
       />
       {value.length >0 &&  <i onClick={()=>{setValue('')}} className="cursor-pointer text-2xl ri-close-line"></i>}
