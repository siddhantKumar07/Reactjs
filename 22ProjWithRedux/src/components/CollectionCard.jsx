...
const CollectionCard = ({elem,idx,handleRemove}) => {
  return (
   <div key={idx} id='hover'  className='h-140 w-90 rounded-xl relative [content-visibility:auto] [contain-intrinsic-size:280px]'>
        ...
        <a className='h-full w-full rounded-xl ' href={elem.src} target='_blank' rel='noreferrer'>
         ...
         <div className=' title hidden flex items-center gap-2 justify-between absolute  bottom-1 font-bold bg-transparent w-full px-1 py-1'>
