...
localStorage.setItem("collection",JSON.stringify(newData));
  ...
  return (
    <div id='hover' className='h-140 w-90 rounded-xl relative [content-visibility:auto] [contain-intrinsic-size:280px]'>
       ...
       <h1  className=' font-bold  text-black capitalize text-md w-[75%] '>{elem.title}</h1>
       <button className='rounded-md cursor-pointer active:scale-90 px-4 py-1 bg-blue-700 text-white text-lg'
       onClick={()=>{
