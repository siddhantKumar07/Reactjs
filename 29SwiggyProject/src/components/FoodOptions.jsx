...
const FoodOptions = () => {
  return (
    <div className="w-full py-7 flex justify-center flex-col items-center gap-5">
      ...
      <div className="w-[85%] h-[420px]  px-3 py-2 grid grid-rows-2 grid-flow-col auto-cols-[140px] gap-6 overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-emerald-300">
        {foodGrid.map((item) => (
