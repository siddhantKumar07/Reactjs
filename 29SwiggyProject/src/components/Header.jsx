...
const Header = () => {
  return (
    <header className='bg-[#FF5200] h-screen w-full p-1  relative'>
        <div className='h-[10%] w-full px-32  mt-7 flex items-center shrink-0 justify-between'>
        ...
        <div className='h-[35%] w-[60%] mx-auto flex flex-col gap-10 mt-16  px-4'>
          <h1 className='text-5xl px-10 text-center font-bold text-white'>Order food & groceries. Discover best restaurants. Swiggy it!</h1>
